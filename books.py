...
join1 = pd.read_sql("""SELECT author.author_name , book.book_title
...
join2 = pd.read_sql("""SELECT author.author_name , book.book_title
...
join3 = pd.read_sql("""SELECT author.author_name,book.book_title FROM author CROSS JOIN book WHERE author.author_id <=2
